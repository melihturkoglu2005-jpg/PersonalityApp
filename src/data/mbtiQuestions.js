...
export const mbtiQuestions = [
  ...
  { id: 2,  fonksiyon: 'Ni', soru: 'Olayların nereye gideceğini, gerçekleşmeden önce sezebiliyorum.' },
  { id: 3,  fonksiyon: 'Ni', soru: 'Semboller ve metaforlar aracılığıyla düşünmek bana doğal gelir.' },
  { id: 4,  fonksiyon: 'Ni', soru: 'Zihnimde sürekli derin ve soyut bir vizyon şekillenir.' },
  { id: 5,  fonksiyon: 'Ni', soru: 'Bir şeyin "doğru" olduğunu kanıtlayamasam da içten hissettiğim anlar olur.' },

  // --- Ne (Dışa Dönük Sezgi) ---
  { id: 6,  fonksiyon: 'Ne', soru: 'Bir fikirden çok hızlı başka fikirlere geçiş yaparım.' },
  { id: 7,  fonksiyon: 'Ne', soru: 'Olasılıkları ve alternatifleri keşfetmek beni heyecanlandırır.' },
  { id: 8,  fonksiyon: 'Ne', soru: 'Farklı alanlardaki kavramlar arasında bağlantılar kurmaktan keyif alırım.' },
  { id: 9,  fonksiyon: 'Ne', soru: 'Yeni bir fikir üretmek, o fikri hayata geçirmekten daha ilgi çekicidir.' },
  { id: 10, fonksiyon: 'Ne', soru: 'Beyin fırtınası yaparken fikirler birbirini tetikleyerek çoğalır.' },

  // --- Si (İçe Dönük Duyum) ---
  { id: 11, fonksiyon: 'Si', soru: 'Geçmişteki deneyimlerim, bugün nasıl davranacağımı büyük ölçüde etkiler.' },
  { id: 12, fonksiyon: 'Si', soru: 'Alışkanlıklarım ve rutinlerim benim için önemli bir güvence kaynağıdır.' },
  { id: 13, fonksiyon: 'Si', soru: 'Bir koku, ses veya dokunuş geçmişteki anıları canlı bir şekilde geri getirebilir.' },
  { id: 14, fonksiyon: 'Si', soru: 'Denenmiş ve işe yaramış yöntemlere güvenmeyi tercih ederim.' },
  { id: 15, fonksiyon: 'Si', soru: 'Ayrıntıları ve geçmiş bilgileri doğru şekilde hatırlamak benim için kolaydır.' },

  // --- Se (Dışa Dönük Duyum) ---
  { id: 16, fonksiyon: 'Se', soru: 'Şu an yaşadığım anı tamamen hissederek yaşamayı severim.' },
  { id: 17, fonksiyon: 'Se', soru: 'Fiziksel çevre ve estetik benim için oldukça önemlidir.' },
  { id: 18, fonksiyon: 'Se', soru: 'Ani gelişmelere hızlı ve etkili bir şekilde tepki verebilirim.' },
  ...
  { id: 29, fonksiyon: 'Te', soru: 'Bir gruba liderlik etmek ve organize etmek bana doğal gelir.' },
  ...
  { id: 34, fonksiyon: 'Fi', soru: 'Kendime özgü bir kimliğim ve değerler setim olduğunu güçlü bir şekilde hissederim.' },
  ...
  { id: 40, fonksiyon: 'Fe', soru: 'İnsanları bir araya getirmek ve bağ kurmalarını sağlamak bana doğal gelir.' },
];